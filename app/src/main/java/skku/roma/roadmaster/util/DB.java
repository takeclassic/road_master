...
public class DB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_MAPNODE_TABLE);
        db.execSQL(CREATE_MAPEDGE_TABLE);
        db.execSQL(CREATE_CLASSLIST_TABLE);
    }
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // on upgrade drop older tables
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_BUILDING + "," + TABLE_CLASSLIST + "," + TABLE_MAPEDGE + "," + TABLE_MAPNODE);
        // create new tables
        onCreate(db);
